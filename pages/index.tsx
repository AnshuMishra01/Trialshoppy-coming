  ...
  return (
    ...
    <main>
      ...
      <div id="contet">
        ...
        <h1 className="jt__text md:pl-20 text-2xl mt-20 md:ml-20 md:text-4xl text-white heading font-bold">&nbsp;&nbsp;&nbsp;A New <span className='text-red-400  flicker'>Attractive</span> </h1>
        ...
        <h1 className="jt__text pl-3 md:pl-20 text-2xl mt-5 md:ml-20 md:text-4xl text-white font-bold heading">&nbsp;&nbsp;&nbsp;Way of <span className='text-green-400 flicker'>S</span>hopping</h1>
