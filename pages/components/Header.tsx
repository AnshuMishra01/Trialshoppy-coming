...
function Header() {
  return (
    <nav className="px-2 sm:px-4 py-1 bg-black">
  <div className="container flex flex-wrap items-center justify-between mx-auto">
    <div className='flex space-x-3 pt-2'>
    {/* <div><Image src={logo} alt="logo" className='image' /></div> */}
    <div><h6 className= "md:self-center text-2xl md:text-3xl font-bold whitespace-nowrap text-white"><Link href="/">TrialShoppy
    </Link>
    </h6></div>
    </div>
